...
import { HexGrid, Hex, Layout, Hexagon } from "react-hexgrid";

const serializedBoard = "RST-WBSB-WTDTR-WRWS-BWS";
const boardColours: { [key: string]: string } = {
  W: "#ccb804",
  S: "#a5c13f",
  R: "#7f7f7f",
  T: "#3a7044",
...
const getCubeCoords = (serializedBoard: string) => {
  /*
  ...
  for (const row of rows) {
    ...
    for (const hexLetter of row) {
      ...
      const style = { fill: boardColours[hexLetter] };
